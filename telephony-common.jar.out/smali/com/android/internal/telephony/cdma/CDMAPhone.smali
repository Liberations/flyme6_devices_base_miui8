...
.method public dial(Ljava/lang/String;Lcom/android/internal/telephony/UUSInfo;ILandroid/os/Bundle;)Lcom/android/internal/telephony/Connection;
    ...
    const-string v13, "Sending UUS information NOT supported in CDMA!"
    ...
    .line 457
    :cond_0
    invoke-virtual/range {p0 .. p0}, Lcom/android/internal/telephony/cdma/CDMAPhone;->getSubId()I

    move-result v12

    move-object/from16 v0, p1

    invoke-static {v12, v0}, Landroid/telephony/PhoneNumberUtils;->isEmergencyNumber(ILjava/lang/String;)Z
    ...
    invoke-virtual {v6}, Lcom/android/internal/telephony/imsphone/ImsPhone;->isVideoCallEnabled()Z
    ...
    invoke-virtual {v0, v1}, Lcom/android/internal/telephony/cdma/CDMAPhone;->shallDialOnCircuitSwitch(Landroid/os/Bundle;)Z
    ...
    iget-object v12, v0, Lcom/android/internal/telephony/cdma/CDMAPhone;->mContext:Landroid/content/Context;
    ...
    invoke-static {v12}, Lcom/android/ims/ImsManager;->isNonTtyOrTtyOnVolteEnabled(Landroid/content/Context;)Z
    ...
    const-string v14, "imsUseEnabled="
    ...
    const-string v14, ", useImsForEmergency="
    ...
    const-string v14, ", imsPhone.isVolteEnabled()="
    ...
    const-string v14, ", imsPhone.isVowifiEnabled()="
    ...
    const-string v14, ", imsPhone.isVideoCallEnabled()="
    ...
    const-string v14, ", imsPhone.getServiceState().getState()="
    ...
    iget-object v12, v0, Lcom/android/internal/telephony/cdma/CDMAPhone;->mImsPhone:Lcom/android/internal/telephony/imsphone/ImsPhone;

    move-object/from16 v0, p0

    iget-object v13, v0, Lcom/android/internal/telephony/cdma/CDMAPhone;->mContext:Landroid/content/Context;

    invoke-static {v12, v13}, Lcom/android/internal/telephony/imsphone/ImsPhone;->checkWfcWifiOnlyModeBeforeDial(Lcom/android/internal/telephony/imsphone/ImsPhone;Landroid/content/Context;)V
    ...
    iget-object v12, v0, Lcom/android/internal/telephony/cdma/CDMAPhone;->LOG_TAG:Ljava/lang/String;

    const-string v13, "Trying IMS PS call"
    ...
    .line 460
    .end local v7    # "imsUseEnabled":Z
    .end local v9    # "isUt":Z
    .end local v10    # "useImsForEmergency":Z
    .end local v11    # "useImsForUt":Z
    :cond_4
    const/4 v7, 0x0
    ...
    .line 467
    .restart local v7    # "imsUseEnabled":Z
    :cond_5
    const/4 v10, 0x0
    ...
    .line 477
    .restart local v9    # "isUt":Z
    .restart local v10    # "useImsForEmergency":Z
    :cond_6
    const/4 v11, 0x0
    ...
    .line 480
    .restart local v11    # "useImsForUt":Z
    :cond_7
    ...
    const-string v14, "IMS PS call exception "
    ...
    invoke-direct {v4, v12}, Lcom/android/internal/telephony/CallStateException;-><init>(Ljava/lang/String;)V
    ...
    invoke-virtual {v4, v12}, Lcom/android/internal/telephony/CallStateException;->setStackTrace([Ljava/lang/StackTraceElement;)V
    ...
    iget-object v12, v0, Lcom/android/internal/telephony/cdma/CDMAPhone;->mSST:Lcom/android/internal/telephony/cdma/CdmaServiceStateTracker;
    ...
    const-string v13, "Trying (non-IMS) CS call"

    invoke-static {v12, v13}, Landroid/telephony/Rlog;->d(Ljava/lang/String;Ljava/lang/String;)I

    .line 518
    invoke-static/range {p4 .. p4}, Lcom/android/internal/telephony/cdma/CDMAPhoneInjector;->isLivetalk(Landroid/os/Bundle;)Z
    ...
    iget-object v12, v0, Lcom/android/internal/telephony/cdma/CDMAPhone;->mCT:Lcom/android/internal/telephony/cdma/CdmaCallTracker;
    ...
    invoke-virtual {v12, v13, v14, v15}, Lcom/android/internal/telephony/cdma/CdmaCallTracker;->dial(Ljava/lang/String;IZ)Lcom/android/internal/telephony/Connection;
    ...
    invoke-virtual {v0, v1, v12, v2, v3}, Lcom/android/internal/telephony/cdma/CDMAPhone;->dialInternal(Ljava/lang/String;Lcom/android/internal/telephony/UUSInfo;ILandroid/os/Bundle;)Lcom/android/internal/telephony/Connection;
...
.method public selectNetworkManually(Lcom/android/internal/telephony/OperatorInfo;Landroid/os/Message;)V
    ...
    invoke-virtual {p0, p1, v0, p2}, Lcom/android/internal/telephony/cdma/CDMAPhone;->selectNetworkManually(Lcom/android/internal/telephony/OperatorInfo;ZLandroid/os/Message;)V
