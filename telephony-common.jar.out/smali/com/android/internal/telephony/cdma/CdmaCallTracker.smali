...
.field mLivetalkCdmaCallTracker:Lcom/android/internal/telephony/cdma/LivetalkCdmaCallTracker;
...
.method constructor <init>(Lcom/android/internal/telephony/cdma/CDMAPhone;)V
    ...
    .line 99
    new-instance v0, Lcom/android/internal/telephony/cdma/LivetalkCdmaCallTracker;

    invoke-direct {v0, p0}, Lcom/android/internal/telephony/cdma/LivetalkCdmaCallTracker;-><init>(Lcom/android/internal/telephony/cdma/CdmaCallTracker;)V

    iput-object v0, p0, Lcom/android/internal/telephony/cdma/CdmaCallTracker;->mLivetalkCdmaCallTracker:Lcom/android/internal/telephony/cdma/LivetalkCdmaCallTracker;
...
.method private dialThreeWay(Ljava/lang/String;Z)Lcom/android/internal/telephony/Connection;
    .locals 4
    .param p1, "dialString"    # Ljava/lang/String;
    .param p2, "isLivetalk"    # Z
    ...
    .line 340
    iget-object v0, p0, Lcom/android/internal/telephony/cdma/CdmaCallTracker;->mLivetalkCdmaCallTracker:Lcom/android/internal/telephony/cdma/LivetalkCdmaCallTracker;

    const/4 v1, 0x1

    invoke-virtual {v0, v1}, Lcom/android/internal/telephony/cdma/LivetalkCdmaCallTracker;->dial(Z)V
...
.method private handleCallWaitingInfo(Lcom/android/internal/telephony/cdma/CdmaCallWaitingNotification;)V
    ...
    invoke-virtual {v0, p1}, Lcom/android/internal/telephony/cdma/LivetalkCdmaCallTracker;->handleCallWaitingInfoInLivetalk(Lcom/android/internal/telephony/cdma/CdmaCallWaitingNotification;)V
    ...
    invoke-virtual {v0, p1}, Lcom/android/internal/telephony/cdma/LivetalkCdmaCallTracker;->acceptBackCallInCallWaiting(Lcom/android/internal/telephony/cdma/CdmaCallWaitingNotification;)Z
...
.method private updatePhoneState()V
    ...
    .line 558
    iget-object v3, p0, Lcom/android/internal/telephony/cdma/CdmaCallTracker;->mLivetalkCdmaCallTracker:Lcom/android/internal/telephony/cdma/LivetalkCdmaCallTracker;
    ...
    :goto_2
    invoke-virtual {v3, v2}, Lcom/android/internal/telephony/cdma/LivetalkCdmaCallTracker;->isCallbackState(Z)Z
...
.method dial(Ljava/lang/String;I)Lcom/android/internal/telephony/Connection;
    ...
    invoke-virtual {p0, p1, p2, v0}, Lcom/android/internal/telephony/cdma/CdmaCallTracker;->dial(Ljava/lang/String;IZ)Lcom/android/internal/telephony/Connection;
...
.method dial(Ljava/lang/String;IZ)Lcom/android/internal/telephony/Connection;
    ...
    .line 258
    invoke-direct {p0, p1, p3}, Lcom/android/internal/telephony/cdma/CdmaCallTracker;->dialThreeWay(Ljava/lang/String;Z)Lcom/android/internal/telephony/Connection;
    ...
    iput-boolean v9, v8, Lcom/android/internal/telephony/cdma/CdmaConnection;->mIsLiveTalk:Z

    .line 303
    iget-object v8, p0, Lcom/android/internal/telephony/cdma/CdmaCallTracker;->mLivetalkCdmaCallTracker:Lcom/android/internal/telephony/cdma/LivetalkCdmaCallTracker;

    const/4 v9, 0x0

    invoke-virtual {v8, v9}, Lcom/android/internal/telephony/cdma/LivetalkCdmaCallTracker;->dial(Z)V
...
.method public dispose()V
    ...
    .line 139
    iget-object v4, p0, Lcom/android/internal/telephony/cdma/CdmaCallTracker;->mLivetalkCdmaCallTracker:Lcom/android/internal/telephony/cdma/LivetalkCdmaCallTracker;

    invoke-virtual {v4}, Lcom/android/internal/telephony/cdma/LivetalkCdmaCallTracker;->fakeResetAll()V
...
.method protected handlePollCalls(Landroid/os/AsyncResult;)V
    ...
    iget-object v0, v0, Lcom/android/internal/telephony/cdma/CdmaCallTracker;->mLivetalkCdmaCallTracker:Lcom/android/internal/telephony/cdma/LivetalkCdmaCallTracker;
    ...
    invoke-virtual {v0, v10, v1, v7}, Lcom/android/internal/telephony/cdma/LivetalkCdmaCallTracker;->getStateForConnection(Lcom/android/internal/telephony/DriverCall;ILcom/android/internal/telephony/cdma/CdmaConnection;)I
    ...
    invoke-virtual {v0, v1, v10}, Lcom/android/internal/telephony/cdma/LivetalkCdmaCallTracker;->isHandle(ILcom/android/internal/telephony/DriverCall;)Z
    ...
    new-instance v28, Lcom/android/internal/telephony/cdma/CdmaConnection;
    ...
    sget-object v28, Lcom/android/internal/telephony/Call$State;->HOLDING:Lcom/android/internal/telephony/Call$State;
    ...
    invoke-virtual/range {v27 .. v27}, Lcom/android/internal/telephony/cdma/CdmaConnection;->onConnectedInOrOut()V
    ...
    invoke-virtual/range {v27 .. v28}, Lcom/android/internal/telephony/cdma/CDMAPhone;->notifyHandoverStateChanged(Lcom/android/internal/telephony/Connection;)V
    ...
    const-string v28, "adding fgCall cn "
    ...
    const-string v28, " to droppedDuringPoll"
    ...
    const-string v28, "adding rgCall cn "
    ...
    invoke-virtual/range {v27 .. v28}, Lcom/android/internal/telephony/cdma/CdmaCall;->setGeneric(Z)V
    ...
    iget-object v0, v0, Lcom/android/internal/telephony/cdma/LivetalkCdmaCallTracker;->mFakeNumbers:[Ljava/lang/String;
    ...
    invoke-virtual {v0, v1}, Lcom/android/internal/telephony/cdma/LivetalkCdmaCallTracker;->fakeReset(I)V
    ...
    const-string v29, "Error in RIL, Phantom call appeared "
    ...
    invoke-virtual {v0, v1, v7, v10}, Lcom/android/internal/telephony/cdma/LivetalkCdmaCallTracker;->isStartDTMF(ILcom/android/internal/telephony/cdma/CdmaConnection;Lcom/android/internal/telephony/DriverCall;)Z
    ...
    iget-boolean v0, v0, Lcom/android/internal/telephony/cdma/LivetalkCdmaCallTracker;->mIsFakePendingMO:Z
    ...
    iget-boolean v0, v0, Lcom/android/internal/telephony/cdma/LivetalkCdmaCallTracker;->mIsFakeLocalHangup:Z
    ...
    invoke-virtual/range {v27 .. v28}, Lcom/android/internal/telephony/cdma/LivetalkCdmaCallTracker;->fakeReset(I)V
    ...
    invoke-static/range {v27 .. v27}, Lmiui/telephony/livetalk/LivetalkUtils;->isLiveTalkCallbackNumber(Ljava/lang/String;)Z
    ...
    .line 873
    .end local v7    # "conn":Lcom/android/internal/telephony/cdma/CdmaConnection;
    .end local v26    # "wasDisconnected":Z
    :cond_25
    move-object/from16 v0, p0
    ...
    const-string v28, "handlePollCalls - disconnect hoConn= "
    ...
    invoke-virtual/range {v27 .. v27}, Lcom/android/internal/telephony/Call$State;->isRinging()Z
    ...
    invoke-interface/range {v27 .. v28}, Lcom/android/internal/telephony/CommandsInterface;->getLastCallFailCause(Landroid/os/Message;)V
    ...
    invoke-virtual/range {v27 .. v27}, Lcom/android/internal/telephony/cdma/CDMAPhone;->notifyPreciseCallStateChanged()V
...
.method hangup(Lcom/android/internal/telephony/cdma/CdmaConnection;)V
    ...
    .line 938
    iget-object v1, p0, Lcom/android/internal/telephony/cdma/CdmaCallTracker;->mLivetalkCdmaCallTracker:Lcom/android/internal/telephony/cdma/LivetalkCdmaCallTracker;

    iget-boolean v1, v1, Lcom/android/internal/telephony/cdma/LivetalkCdmaCallTracker;->mIsFakePendingMO:Z

    if-eqz v1, :cond_4

    .line 939
    invoke-virtual {p0}, Lcom/android/internal/telephony/cdma/CdmaCallTracker;->pollCallsAfterDelay()V

    .line 941
    :cond_4
    iget-object v1, p0, Lcom/android/internal/telephony/cdma/CdmaCallTracker;->mLivetalkCdmaCallTracker:Lcom/android/internal/telephony/cdma/LivetalkCdmaCallTracker;

    invoke-virtual {v1}, Lcom/android/internal/telephony/cdma/LivetalkCdmaCallTracker;->hangup()V
