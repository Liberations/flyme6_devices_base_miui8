...
.method private tryToNotifySsnRegistrants(Landroid/os/AsyncResult;)V
    .locals 2
    ...
    .line 2239
    iput-object p1, p0, Lcom/android/internal/telephony/gsm/GSMPhone;->mCacheSsnAr:Landroid/os/AsyncResult;
...
.method public dial(Ljava/lang/String;Lcom/android/internal/telephony/UUSInfo;ILandroid/os/Bundle;)Lcom/android/internal/telephony/Connection;
    ...
    .line 852
    .local v14, "isEmergency":Z
    move-object/from16 v0, p0

    iget-object v12, v0, Lcom/android/internal/telephony/gsm/GSMPhone;->mImsPhone:Lcom/android/internal/telephony/imsphone/ImsPhone;

    .line 854
    .local v12, "imsPhone":Lcom/android/internal/telephony/imsphone/ImsPhone;
    ...
    invoke-virtual {v12}, Lcom/android/internal/telephony/imsphone/ImsPhone;->isVolteEnabled()Z

    move-result v4

    if-nez v4, :cond_0

    invoke-virtual {v12}, Lcom/android/internal/telephony/imsphone/ImsPhone;->isVowifiEnabled()Z

    move-result v4

    if-nez v4, :cond_0

    invoke-virtual {v12}, Lcom/android/internal/telephony/imsphone/ImsPhone;->isVideoCallEnabled()Z
    ...
    :cond_0
    invoke-virtual {v12}, Lcom/android/internal/telephony/imsphone/ImsPhone;->getServiceState()Landroid/telephony/ServiceState;
    ...
    .line 868
    .local v16, "useImsForEmergency":Z
    :goto_1
    ...
    invoke-virtual {v12}, Lcom/android/internal/telephony/imsphone/ImsPhone;->isUtEnabled()Z
    ...
    .line 874
    .local v17, "useImsForUt":Z
    :goto_2
    move-object/from16 v0, p0

    iget-object v5, v0, Lcom/android/internal/telephony/gsm/GSMPhone;->LOG_TAG:Ljava/lang/String;
    ...
    const-string v6, ", imsPhone.isVideoCallEnabled()="
    ...
    iget-object v4, v0, Lcom/android/internal/telephony/gsm/GSMPhone;->LOG_TAG:Ljava/lang/String;
    ...
    invoke-virtual {v12, v0, v1, v2, v3}, Lcom/android/internal/telephony/imsphone/ImsPhone;->dial(Ljava/lang/String;Lcom/android/internal/telephony/UUSInfo;ILandroid/os/Bundle;)Lcom/android/internal/telephony/Connection;
    :try_end_0
    .catch Lcom/android/internal/telephony/CallStateException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    .line 854
    .end local v13    # "imsUseEnabled":Z
    .end local v15    # "isUt":Z
    .end local v16    # "useImsForEmergency":Z
    .end local v17    # "useImsForUt":Z
    :cond_3
    const/4 v13, 0x0
    ...
    .line 861
    .restart local v13    # "imsUseEnabled":Z
    :cond_4
    const/16 v16, 0x0
    ...
    .line 871
    .restart local v15    # "isUt":Z
    .restart local v16    # "useImsForEmergency":Z
    :cond_5
    const/16 v17, 0x0
    ...
    .line 874
    .restart local v17    # "useImsForUt":Z
    :cond_6
    const-string v4, "N/A"
    ...
    invoke-direct {v10, v4}, Lcom/android/internal/telephony/CallStateException;-><init>(Ljava/lang/String;)V
    ...
    invoke-virtual {v10, v4}, Lcom/android/internal/telephony/CallStateException;->setStackTrace([Ljava/lang/StackTraceElement;)V
    ...
    iget-object v4, v0, Lcom/android/internal/telephony/gsm/GSMPhone;->mUiccApplication:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    invoke-static {v0, v1, v4, v2}, Lcom/android/internal/telephony/gsm/GSMPhoneInjector;->isLivetalk(Lcom/android/internal/telephony/gsm/GSMPhone;Ljava/lang/String;Ljava/util/concurrent/atomic/AtomicReference;Landroid/os/Bundle;)Z
    ...
    iget-object v4, v0, Lcom/android/internal/telephony/gsm/GSMPhone;->mCT:Lcom/android/internal/telephony/gsm/GsmCallTracker;
    ...
    invoke-virtual/range {v4 .. v9}, Lcom/android/internal/telephony/gsm/GsmCallTracker;->dial(Ljava/lang/String;ILcom/android/internal/telephony/UUSInfo;Landroid/os/Bundle;Z)Lcom/android/internal/telephony/Connection;
    ...
    invoke-virtual {v0, v1, v4, v5, v2}, Lcom/android/internal/telephony/gsm/GSMPhone;->dialInternal(Ljava/lang/String;Lcom/android/internal/telephony/UUSInfo;ILandroid/os/Bundle;)Lcom/android/internal/telephony/Connection;
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    invoke-direct {v0, v4}, Lcom/android/internal/telephony/gsm/GSMPhone;->tryToNotifySsnRegistrants(Landroid/os/AsyncResult;)V
...
.method public registerForSuppServiceNotification(Landroid/os/Handler;ILjava/lang/Object;)V
    ...
    invoke-direct {p0, v0}, Lcom/android/internal/telephony/gsm/GSMPhone;->tryToNotifySsnRegistrants(Landroid/os/AsyncResult;)V
