...
.method private canUndoEdit(Ljava/lang/CharSequence;IILandroid/text/Spanned;II)Z
    ...
    invoke-static {v1}, Landroid/widget/Editor;->access$4200(Landroid/widget/Editor;)Landroid/content/UndoManager;
    ...
    invoke-static {p1, p2, p3}, Landroid/widget/Editor;->access$4500(Ljava/lang/CharSequence;II)Z
    ...
    # invokes: Landroid/widget/Editor;->isValidRange(Ljava/lang/CharSequence;II)Z
    invoke-static {p4, p5, p6}, Landroid/widget/Editor;->access$4500(Ljava/lang/CharSequence;II)Z
...
.method private recordEdit(Landroid/widget/Editor$EditOperation;Z)V
    ...
    # getter for: Landroid/widget/Editor;->mUndoManager:Landroid/content/UndoManager;
    invoke-static {v2}, Landroid/widget/Editor;->access$4200(Landroid/widget/Editor;)Landroid/content/UndoManager;
    ...
    invoke-static {v3}, Landroid/widget/Editor;->access$4300(Landroid/widget/Editor;)Landroid/content/UndoOwner;
    ...
    # getter for: Landroid/widget/Editor;->mUndoOwner:Landroid/content/UndoOwner;
    invoke-static {v2}, Landroid/widget/Editor;->access$4300(Landroid/widget/Editor;)Landroid/content/UndoOwner;
    ...
    invoke-static {v0, p1}, Landroid/widget/Editor$EditOperation;->access$4400(Landroid/widget/Editor$EditOperation;Landroid/widget/Editor$EditOperation;)Z
