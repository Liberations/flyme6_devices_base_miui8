...
.method public buildStorageVolume(Landroid/content/Context;IZ)Landroid/os/storage/StorageVolume;
    ...
    const-string/jumbo v18, "unmounted"

    .line 338
    .local v18, "envState":Ljava/lang/String;
    :goto_0
    ...
    .line 343
    .restart local v6    # "userPath":Ljava/io/File;
    :cond_0
    const/4 v7, 0x0
    ...
    .line 345
    .local v17, "derivedFsUuid":Ljava/lang/String;
    const-wide/16 v11, 0x0

    .line 346
    .local v11, "mtpReserveSize":J
    ...
    invoke-virtual/range {v21 .. v22}, Landroid/os/storage/StorageManager;->findPrivateForEmulated(Landroid/os/storage/VolumeInfo;)Landroid/os/storage/VolumeInfo;

    move-result-object v20

    .line 353
    .local v20, "privateVol":Landroid/os/storage/VolumeInfo;
    if-eqz v20, :cond_1
    ...
    .line 398
    .end local v20    # "privateVol":Landroid/os/storage/VolumeInfo;
    .local v9, "removable":Z
    :cond_3
    :goto_1
    if-nez v7, :cond_4
    ...
    invoke-direct/range {v3 .. v18}, Landroid/os/storage/StorageVolume;-><init>(Ljava/lang/String;ILjava/io/File;Ljava/lang/String;ZZZJZJLandroid/os/UserHandle;Ljava/lang/String;Ljava/lang/String;)V

    return-object v3

    .line 335
    .end local v5    # "mtpStorageId":I
    .end local v6    # "userPath":Ljava/io/File;
    .end local v7    # "description":Ljava/lang/String;
    .end local v9    # "removable":Z
    .end local v10    # "emulated":Z
    .end local v11    # "mtpReserveSize":J
    .end local v14    # "maxFileSize":J
    .end local v17    # "derivedFsUuid":Ljava/lang/String;
    .end local v18    # "envState":Ljava/lang/String;
    :cond_5
    move-object/from16 v0, p0

    iget v3, v0, Landroid/os/storage/VolumeInfo;->state:I
    ...
    .line 367
    .restart local v5    # "mtpStorageId":I
    .restart local v6    # "userPath":Ljava/io/File;
    .restart local v7    # "description":Ljava/lang/String;
    .restart local v10    # "emulated":Z
    .restart local v11    # "mtpReserveSize":J
    .restart local v14    # "maxFileSize":J
    .restart local v17    # "derivedFsUuid":Ljava/lang/String;
    .restart local v18    # "envState":Ljava/lang/String;
    .restart local v20    # "privateVol":Landroid/os/storage/VolumeInfo;
    :cond_6
    const/4 v9, 0x1

    .restart local v9    # "removable":Z
    goto :goto_1
    ...
    .line 374
    .restart local v9    # "removable":Z
    invoke-virtual/range {v21 .. v22}, Landroid/os/storage/StorageManager;->getBestVolumeDescription(Landroid/os/storage/VolumeInfo;)Ljava/lang/String;
    ...
    iget-object v4, v0, Landroid/os/storage/VolumeInfo;->fsType:Ljava/lang/String;
    ...
    invoke-static {v3}, Landroid/os/storage/VolumeInfo;->buildStableMtpStorageId(Ljava/lang/String;)I
    ...
    const-string v8, "Unexpected volume type "
