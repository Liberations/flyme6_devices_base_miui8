...
.method public handleMessage(Landroid/os/Message;)V
    ...
    invoke-static {v5}, Landroid/hardware/Camera;->access$200(Landroid/hardware/Camera;)Landroid/hardware/Camera$ShutterCallback;
    ...
    invoke-static {v5}, Landroid/hardware/Camera;->access$300(Landroid/hardware/Camera;)Landroid/hardware/Camera$PictureCallback;
    ...
    invoke-static {v5}, Landroid/hardware/Camera;->access$400(Landroid/hardware/Camera;)Landroid/hardware/Camera$PictureCallback;
    ...
    invoke-static {v6}, Landroid/hardware/Camera;->access$500(Landroid/hardware/Camera;)Landroid/hardware/Camera$PreviewCallback;
    ...
    invoke-static {v6}, Landroid/hardware/Camera;->access$600(Landroid/hardware/Camera;)Z
    ...
    invoke-static {v5, v6}, Landroid/hardware/Camera;->access$502(Landroid/hardware/Camera;Landroid/hardware/Camera$PreviewCallback;)Landroid/hardware/Camera$PreviewCallback;
    ...
    invoke-static {v5}, Landroid/hardware/Camera;->access$100(Landroid/hardware/Camera;)Z
    ...
    # invokes: Landroid/hardware/Camera;->reversePreviewFrame([B)V
    invoke-static {v5}, Landroid/hardware/Camera;->access$900([B)V
    ...
    invoke-static {v6}, Landroid/hardware/Camera;->access$700(Landroid/hardware/Camera;)Z
    ...
    invoke-static {v6, v5, v4}, Landroid/hardware/Camera;->access$800(Landroid/hardware/Camera;ZZ)V
    ...
    invoke-static {v5}, Landroid/hardware/Camera;->access$1000(Landroid/hardware/Camera;)Landroid/hardware/Camera$PictureCallback;
    ...
    invoke-static {v6}, Landroid/hardware/Camera;->access$1100(Landroid/hardware/Camera;)Ljava/lang/Object;
    ...
    invoke-static {v7}, Landroid/hardware/Camera;->access$1200(Landroid/hardware/Camera;)Landroid/hardware/Camera$AutoFocusCallback;
    ...
    invoke-static {v6}, Landroid/hardware/Camera;->access$1300(Landroid/hardware/Camera;)Landroid/hardware/Camera$OnZoomChangeListener;
    ...
    invoke-static {v5}, Landroid/hardware/Camera;->access$1400(Landroid/hardware/Camera;)Landroid/hardware/Camera$FaceDetectionListener;
    ...
    invoke-static {v5}, Landroid/hardware/Camera;->access$1500(Landroid/hardware/Camera;)Landroid/hardware/Camera$ErrorCallback;
    ...
    invoke-static {v6}, Landroid/hardware/Camera;->access$1600(Landroid/hardware/Camera;)Landroid/hardware/Camera$AutoFocusMoveCallback;
    ...
    invoke-static {v5}, Landroid/hardware/Camera;->access$1800(Landroid/hardware/Camera;)Landroid/hardware/Camera$CameraDataCallback;
