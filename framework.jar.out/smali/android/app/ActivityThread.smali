...
.method private deliverResults(Landroid/app/ActivityThread$ActivityClientRecord;Ljava/util/List;)V
    ...
    const-string v6, "Delivering result to activity "
...
.method private handleBindService(Landroid/app/ActivityThread$BindServiceData;)V
    ...
    const-string/jumbo v5, "handleBindService s="
...
.method private handleCreateBackupAgent(Landroid/app/ActivityThread$CreateBackupAgentData;)V
    ...
    .line 2780
    sget-boolean v10, Landroid/app/ActivityThread;->DEBUG_BACKUP:Z
    ...
    const-string/jumbo v12, "handleCreateBackupAgent: "
    ...
    const-string v11, "Reusing existing agent instance"
    ...
    const-string v12, "Initializing agent class "
...
.method private handleRelaunchActivity(Landroid/app/ActivityThread$ActivityClientRecord;)V
    ...
    const-string v9, "Abort, activity not relaunching!"
    ...
    const-string v10, "Relaunching activity "
    ...
    const-string v10, " with configChanges=0x"
    ...
    const-string v9, "Relaunching activity "
    ...
    const-string v9, "Handling relaunch of "
...
.method private handleSendResult(Landroid/app/ActivityThread$ResultData;)V
    ...
    .local v1, "r":Landroid/app/ActivityThread$ActivityClientRecord;
    sget-boolean v5, Landroid/app/ActivityThread;->DEBUG_RESULTS:Z
    ...
    const-string v7, "Handling send result to "
...
.method private final incProviderRefLocked(Landroid/app/ActivityThread$ProviderRefCount;Z)V
    ...
    const-string v2, "incProviderRef: stable snatched provider from the jaws of death"
    ...
    const-string v3, "incProviderRef Now stable - "
    ...
    const-string v2, "incProviderRef: unstable snatched provider from the jaws of death"
    ...
    const-string v3, "incProviderRef: Now unstable - "
...
.method private installProvider(Landroid/content/Context;Landroid/app/IActivityManager$ContentProviderHolder;Landroid/content/pm/ProviderInfo;ZZZ)Landroid/app/IActivityManager$ContentProviderHolder;
    ...
    :cond_0
    sget-boolean v15, Landroid/app/ActivityThread;->DEBUG_PROVIDER:Z
    ...
    const-string v17, "Instantiating local provider "
    ...
    const-string v18, "Checking to add "
    ...
    const-string v17, "installProvider: lost the race, using existing local provider"
    ...
    const-string v17, "Installing external provider "
    ...
    const-string v17, "installProvider: lost the race, updating ref count"
...
.method private static performConfigurationChanged(Landroid/content/ComponentCallbacks2;Landroid/content/res/Configuration;)V
    ...
    const-string v5, "Config callback "
    ...
    const-string v5, ": shouldChangeConfig="
...
.method private performLaunchActivity(Landroid/app/ActivityThread$ActivityClientRecord;Landroid/content/Intent;)Landroid/app/Activity;
    ...
    const-string v6, "Launching activity "
...
.method public final acquireExistingProvider(Landroid/content/Context;Landroid/app/ActivityThread$ProviderKey;Z)Landroid/content/IContentProvider;
    ...
    iget-object v8, p2, Landroid/app/ActivityThread$ProviderKey;->authority:Ljava/lang/String;
    ...
    iget v8, p2, Landroid/app/ActivityThread$ProviderKey;->userId:I
    ...
    invoke-virtual {p0, v0, v6}, Landroid/app/ActivityThread;->handleUnstableProviderDiedLocked(Landroid/os/IBinder;Z)V
...
.method public final acquireProvider(Landroid/content/Context;Ljava/lang/String;IZ)Landroid/content/IContentProvider;
    ...
    new-instance v7, Landroid/app/ActivityThread$ProviderKey;

    invoke-direct {v7, p2, p3}, Landroid/app/ActivityThread$ProviderKey;-><init>(Ljava/lang/String;I)V

    .local v7, "key":Landroid/app/ActivityThread$ProviderKey;
    invoke-virtual {p0, p1, v7, p4}, Landroid/app/ActivityThread;->acquireExistingProvider(Landroid/content/Context;Landroid/app/ActivityThread$ProviderKey;Z)Landroid/content/IContentProvider;
    ...
    check-cast v8, Landroid/app/ActivityThread$ProviderAcquiringCount;

    .local v8, "pac":Landroid/app/ActivityThread$ProviderAcquiringCount;
    if-nez v8, :cond_2

    new-instance v8, Landroid/app/ActivityThread$ProviderAcquiringCount;

    .end local v8    # "pac":Landroid/app/ActivityThread$ProviderAcquiringCount;
    const/4 v0, 0x1

    invoke-direct {v8, v0}, Landroid/app/ActivityThread$ProviderAcquiringCount;-><init>(I)V

    .restart local v8    # "pac":Landroid/app/ActivityThread$ProviderAcquiringCount;
    iget-object v0, p0, Landroid/app/ActivityThread;->mProviderAcquiringCountMap:Landroid/util/ArrayMap;
    ...
    :try_start_3
    iget v0, v8, Landroid/app/ActivityThread$ProviderAcquiringCount;->acquiringCount:I

    add-int/lit8 v0, v0, -0x1

    iput v0, v8, Landroid/app/ActivityThread$ProviderAcquiringCount;->acquiringCount:I
    ...
    const-string v5, " acquiringCount "

    invoke-virtual {v3, v5}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v3

    iget v5, v8, Landroid/app/ActivityThread$ProviderAcquiringCount;->acquiringCount:I
...
.method collectComponentCallbacks(ZLandroid/content/res/Configuration;)Ljava/util/ArrayList;
    ...
    const-string v12, "Setting activity "
...
.method final completeRemoveProvider(Landroid/app/ActivityThread$ProviderRefCount;)V
    ...
    const-string v7, "completeRemoveProvider: lost the race, provider still in use"
    ...
    const-string v7, "removeProvider: Invoking ActivityManagerNative.removeContentProvider("
    ...
    iget-object v7, v7, Landroid/app/IActivityManager$ContentProviderHolder;->info:Landroid/content/pm/ProviderInfo;
...
.method final handleActivityConfigurationChanged(Landroid/app/ActivityThread$ActivityConfigChangeData;)V
    ...
    const-string v3, "Handle activity config changed: "
...
.method final handleResumeActivity(Landroid/os/IBinder;ZZZ)V
    ...
    iget-object v9, v4, Landroid/app/ActivityThread$ActivityClientRecord;->activityInfo:Landroid/content/pm/ActivityInfo;
...
.method final handleTrimMemory(I)V
    ...
    const-string v5, "Trimming memory to level: "
...
.method final handleUnstableProviderDiedLocked(Landroid/os/IBinder;Z)V
    ...
    const-string v5, "Cleaning up dead provider "
    ...
    iget-object v5, v2, Landroid/app/ActivityThread$ProviderRefCount;->holder:Landroid/app/IActivityManager$ContentProviderHolder;
...
.method public final releaseProvider(Landroid/content/IContentProvider;Z)Z
    ...
    const-string v7, "releaseProvider: stable ref count already 0, how?"
    ...
    iget-object v9, v3, Landroid/app/ActivityThread$ProviderRefCount;->holder:Landroid/app/IActivityManager$ContentProviderHolder;
    ...
    const-string v8, "releaseProvider: Enqueueing pending removal - "
    ...
    const-string v7, "releaseProvider: unstable ref count already 0, how?"
    ...
    const-string v8, "releaseProvider: No longer unstable - "
...
.method public final sendActivityResult(Landroid/os/IBinder;Ljava/lang/String;IILandroid/content/Intent;)V
    ...
    const-string v3, "sendActivityResult: id="
