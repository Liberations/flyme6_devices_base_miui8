...
.method private prepareNativeDaemon()V
    ...
    iput-boolean v14, v0, Lcom/android/server/NetworkManagementService;->mBandwidthControlEnabled:Z

    new-instance v14, Ljava/io/File;

    const-string v15, "/proc/net/xt_qtaguid/ctrl"
    ...
    const-string v15, "enabling bandwidth control"
    ...
    :goto_0
    const-string v15, "net.qtaguid_enabled"
    ...
    invoke-interface {v14}, Lcom/android/internal/app/IBatteryStats;->noteNetworkStatsEnabled()V
    :try_end_1
    .catch Landroid/os/RemoteException; {:try_start_1 .. :try_end_1} :catch_2
    ...
    iput-boolean v14, v0, Lcom/android/server/NetworkManagementService;->mStrictEnabled:Z
    :try_end_2
    ...
    const-string v17, " active quota rules"
    ...
    iput-object v14, v0, Lcom/android/server/NetworkManagementService;->mActiveQuotas:Ljava/util/HashMap;
    ...
    invoke-virtual {v0, v14, v1, v2}, Lcom/android/server/NetworkManagementService;->setInterfaceQuota(Ljava/lang/String;J)V
    ...
    const-string v15, "problem enabling bandwidth controls"

    invoke-static {v14, v15, v6}, Landroid/util/Log;->wtf(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)I
    ...
    const-string v15, "not enabling bandwidth control"
    ...
    const-string v15, "Failed strict enable"
    ...
    const-string v17, " active alert rules"
    ...
    iput-object v14, v0, Lcom/android/server/NetworkManagementService;->mActiveAlerts:Ljava/util/HashMap;
    ...
    invoke-virtual {v0, v14, v1, v2}, Lcom/android/server/NetworkManagementService;->setInterfaceAlert(Ljava/lang/String;J)V
    ...
    const-string v17, " active UID rules"
    ...
    iget-object v13, v0, Lcom/android/server/NetworkManagementService;->mUidRejectOnQuota:Landroid/util/SparseBooleanArray;

    .local v13, "uidRejectOnQuota":Landroid/util/SparseBooleanArray;
    ...
    iput-object v14, v0, Lcom/android/server/NetworkManagementService;->mUidRejectOnQuota:Landroid/util/SparseBooleanArray;
    ...
    invoke-virtual {v13, v9}, Landroid/util/SparseBooleanArray;->keyAt(I)I

    move-result v14

    invoke-virtual {v13, v9}, Landroid/util/SparseBooleanArray;->valueAt(I)Z

    move-result v15

    move-object/from16 v0, p0

    invoke-virtual {v0, v14, v15}, Lcom/android/server/NetworkManagementService;->setUidNetworkRules(IZ)V
    ...
    .end local v9    # "i":I
    .end local v13    # "uidRejectOnQuota":Landroid/util/SparseBooleanArray;
    :cond_5
    move-object/from16 v0, p0
    ...
    const-string v17, " active UID cleartext policies"
    ...
    iput-object v14, v0, Lcom/android/server/NetworkManagementService;->mUidCleartextPolicy:Landroid/util/SparseIntArray;
    ...
    invoke-virtual {v0, v14, v15}, Lcom/android/server/NetworkManagementService;->setUidCleartextNetworkPolicy(II)V
    ...
    invoke-virtual {v0, v14}, Lcom/android/server/NetworkManagementService;->setFirewallEnabled(Z)V
    ...
    invoke-direct {v0, v14, v15, v1}, Lcom/android/server/NetworkManagementService;->syncFirewallChainLocked(ILandroid/util/SparseIntArray;Ljava/lang/String;)V
    ...
    iget-object v14, v0, Lcom/android/server/NetworkManagementService;->mFirewallChainStates:Landroid/util/SparseBooleanArray;
    ...
    invoke-virtual {v0, v14, v15}, Lcom/android/server/NetworkManagementService;->setFirewallChainEnabled(IZ)V
...
.method private syncFirewallChainLocked(ILandroid/util/SparseIntArray;Ljava/lang/String;)V
    ...
    const-string v5, " active firewall "
...
.method private updateFirewallUidRuleLocked(III)Z
    ...
    const-string v6, "!!!!! Skipping change"
...
.method public setFirewallUidRules(I[I[I)V
    ...
    const-string v10, "setFirewallUidRules() called on invalid chain: "
    ...
    const-string v10, "Error flushing firewall chain "
