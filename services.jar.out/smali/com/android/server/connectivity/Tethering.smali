...
.method static synthetic access$100(Lcom/android/server/connectivity/Tethering;I)V
    .locals 0
...
.method private sendTetherConnectStateChangedBroadcast()V
    ...
    const-string v4, "codeaurora.net.conn.TETHER_CONNECT_STATE_CHANGED"
    ...
    invoke-virtual {p0, v4}, Lcom/android/server/connectivity/Tethering;->isWifi(Ljava/lang/String;)Z
    ...
    invoke-virtual {v3}, Lcom/android/server/connectivity/Tethering$TetherInterfaceSM;->getHandler()Landroid/os/Handler;

    move-result-object v4

    new-instance v5, Lcom/android/server/connectivity/Tethering$1;

    invoke-direct {v5, p0}, Lcom/android/server/connectivity/Tethering$1;-><init>(Lcom/android/server/connectivity/Tethering;)V
