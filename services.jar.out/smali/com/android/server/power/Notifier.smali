...
# static fields
.field private static final ACTION_SCREEN_OFF_PROXIMITY:Ljava/lang/String; = "com.android.nfc.action.SCREEN_OFF"

.field private static final ACTION_SCREEN_ON_PROXIMITY:Ljava/lang/String; = "com.android.nfc.action.SCREEN_ON"
...
.field private static final MSG_PROXIMITY_ON_CHANGE:I = 0x5
...
.field private static final PROXIMITY_STATE_SCREEN_OFF:I = 0x2

.field private static final PROXIMITY_STATE_SCREEN_ON:I = 0x1
...
.field private final mProximityChangeDone:Landroid/content/BroadcastReceiver;

.field private mProximityScreenOnOffState:I
...
.field private final mScreenOffProximityIntent:Landroid/content/Intent;

.field private final mScreenOnIntent:Landroid/content/Intent;

.field private final mScreenOnProximityIntent:Landroid/content/Intent;
...
.method public constructor <init>(Landroid/os/Looper;Landroid/content/Context;Lcom/android/internal/app/IBatteryStats;Lcom/android/internal/app/IAppOpsService;Lcom/android/server/power/SuspendBlocker;Landroid/view/WindowManagerPolicy;)V
    ...
    iput-object v0, p0, Lcom/android/server/power/Notifier;->mProximityChangeDone:Landroid/content/BroadcastReceiver;
    ...
    .line 703
    new-instance v0, Lcom/android/server/power/Notifier$9;

    invoke-direct {v0, p0}, Lcom/android/server/power/Notifier$9;-><init>(Lcom/android/server/power/Notifier;)V
    ...
    const-string v1, "com.android.nfc.action.SCREEN_ON"

    invoke-direct {v0, v1}, Landroid/content/Intent;-><init>(Ljava/lang/String;)V

    iput-object v0, p0, Lcom/android/server/power/Notifier;->mScreenOnProximityIntent:Landroid/content/Intent;

    .line 160
    iget-object v0, p0, Lcom/android/server/power/Notifier;->mScreenOnProximityIntent:Landroid/content/Intent;
    ...
    const-string v1, "com.android.nfc.action.SCREEN_OFF"

    invoke-direct {v0, v1}, Landroid/content/Intent;-><init>(Ljava/lang/String;)V

    iput-object v0, p0, Lcom/android/server/power/Notifier;->mScreenOffProximityIntent:Landroid/content/Intent;

    .line 163
    iget-object v0, p0, Lcom/android/server/power/Notifier;->mScreenOffProximityIntent:Landroid/content/Intent;
...
.method static synthetic access$800(Lcom/android/server/power/Notifier;)V
    ...
    .prologue
    .line 70
    invoke-direct {p0}, Lcom/android/server/power/Notifier;->sendProximityChangeBroadcast()V
...
.method private sendProximityChangeBroadcast()V
    .locals 9
    ...
    .line 633
    iget v0, p0, Lcom/android/server/power/Notifier;->mProximityScreenOnOffState:I
    ...
    iget-object v1, p0, Lcom/android/server/power/Notifier;->mScreenOnProximityIntent:Landroid/content/Intent;

    sget-object v2, Landroid/os/UserHandle;->ALL:Landroid/os/UserHandle;

    iget-object v4, p0, Lcom/android/server/power/Notifier;->mProximityChangeDone:Landroid/content/BroadcastReceiver;
    ...
    iget-object v1, p0, Lcom/android/server/power/Notifier;->mScreenOffProximityIntent:Landroid/content/Intent;
...
# virtual methods
.method public onProximityScreenOff()V
    .locals 3
    ...
    iput v1, p0, Lcom/android/server/power/Notifier;->mProximityScreenOnOffState:I
...
.method public onProximityScreenOn()V
    .locals 4
    ...
    .line 373
    iput v3, p0, Lcom/android/server/power/Notifier;->mProximityScreenOnOffState:I
