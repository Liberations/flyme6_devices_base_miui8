...
.method private insertTaskAtTop(Lcom/android/server/am/TaskRecord;Lcom/android/server/am/ActivityRecord;)V
    ...
    iget-object v9, p2, Lcom/android/server/am/ActivityRecord;->info:Landroid/content/pm/ActivityInfo;
    ...
    invoke-virtual {v7, v11}, Lcom/android/server/am/TaskRecord;->topRunningActivityLocked(Lcom/android/server/am/ActivityRecord;)Lcom/android/server/am/ActivityRecord;
    ...
    invoke-virtual {v9, v6, p1}, Ljava/util/ArrayList;->add(ILjava/lang/Object;)V
    ...
    iget v5, v9, Lcom/android/server/am/TaskRecord;->taskType:I
...
.method private relaunchActivityLocked(Lcom/android/server/am/ActivityRecord;IZ)Z
    ...
    invoke-static {v1, v0, v5}, Lcom/android/server/am/MiuiSysUserServiceHelper;->notifyAMResumeActivity(Landroid/content/ComponentName;II)V
...
.method private resumeTopActivityInnerLocked(Lcom/android/server/am/ActivityRecord;Landroid/os/Bundle;)Z
    ...
    const v4, #android:integer@resumeboost_timeout_param#t
    ...
    invoke-static {v4, v3, v5}, Lcom/android/server/am/MiuiSysUserServiceHelper;->notifyAMResumeActivity(Landroid/content/ComponentName;II)V
...
.method final destroyActivityLocked(Lcom/android/server/am/ActivityRecord;ZLjava/lang/String;)Z
    ...
    invoke-static {v5, v7}, Lcom/android/server/am/MiuiSysUserServiceHelper;->notifyAMDestroyActivity(II)V
...
.method final moveTaskToBackLocked(I)Z
    ...
    :cond_2
    sget-boolean v14, Lcom/android/server/am/ActivityManagerDebugConfig;->DEBUG_TRANSITION:Z
    ...
    const-string v16, "Prepare to back transition: task="
...
.method final startPausingLocked(ZZZZ)Z
    ...
    invoke-static {v0, v2}, Lcom/android/server/am/MiuiSysUserServiceHelper;->notifyAMPauseActivity(II)V
