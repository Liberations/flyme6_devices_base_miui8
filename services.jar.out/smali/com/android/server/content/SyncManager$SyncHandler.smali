...
.method private dispatchSyncOperation(Lcom/android/server/content/SyncOperation;)Z
    ...
    invoke-static {v2, v1}, Lcom/android/server/content/SyncManager;->access$4500(Lcom/android/server/content/SyncManager;Lcom/android/server/content/SyncManager$ActiveSyncContext;)V
...
.method private installHandleTooManyDeletesNotification(Landroid/accounts/Account;Ljava/lang/String;JI)V
    ...
    invoke-static {v2}, Lcom/android/server/content/SyncManager;->access$4800(Lcom/android/server/content/SyncManager;)Landroid/app/NotificationManager;
    ...
    invoke-static {v2, v7}, Lcom/android/server/content/SyncManager;->access$5300(Lcom/android/server/content/SyncManager;Landroid/os/UserHandle;)Landroid/content/Context;
...
.method private isOperationValidLocked(Lcom/android/server/content/SyncOperation;)Z
    ...
    invoke-static {v12}, Lcom/android/server/content/SyncManager;->access$4400(Lcom/android/server/content/SyncManager;)Landroid/net/ConnectivityManager;
...
.method private isSyncNotUsingNetworkH(Lcom/android/server/content/SyncManager$ActiveSyncContext;)Z
    ...
    invoke-static {v14, v15}, Lcom/android/server/content/SyncManager;->access$4300(Lcom/android/server/content/SyncManager;I)J
...
.method private manageSyncAlarmLocked(JJ)V
    ...
    # getter for: Lcom/android/server/content/SyncManager;->mBatteryIsLow:Z
    invoke-static/range {v17 .. v17}, Lcom/android/server/content/SyncManager;->access$4900(Lcom/android/server/content/SyncManager;)Z
    ...
    invoke-static/range {v17 .. v17}, Lcom/android/server/content/SyncManager;->access$5000(Lcom/android/server/content/SyncManager;)V
    ...
    invoke-static/range {v17 .. v17}, Lcom/android/server/content/SyncManager;->access$5200(Lcom/android/server/content/SyncManager;)Landroid/app/AlarmManager;
    ...
    invoke-static/range {v19 .. v19}, Lcom/android/server/content/SyncManager;->access$5100(Lcom/android/server/content/SyncManager;)Landroid/app/PendingIntent;
    ...
    # getter for: Lcom/android/server/content/SyncManager;->mSyncAlarmIntent:Landroid/app/PendingIntent;
    invoke-static/range {v18 .. v18}, Lcom/android/server/content/SyncManager;->access$5100(Lcom/android/server/content/SyncManager;)Landroid/app/PendingIntent;
...
.method private maybeStartNextSyncH()J
    ...
    # invokes: Lcom/android/server/content/SyncManager;->isBatteryLowForbidden(Lcom/android/server/content/SyncOperation;)Z
    invoke-static {v0, v1}, Lcom/android/server/content/SyncManager;->access$3700(Lcom/android/server/content/SyncManager;Lcom/android/server/content/SyncOperation;)Z
    ...
    # invokes: Lcom/android/server/content/SyncManager;->isBatteryChargingForbidden(Lcom/android/server/content/SyncOperation;)Z
    invoke-static {v0, v1}, Lcom/android/server/content/SyncManager;->access$3800(Lcom/android/server/content/SyncManager;Lcom/android/server/content/SyncOperation;)Z
    ...
    # invokes: Lcom/android/server/content/SyncManager;->isMeteredNetworkForbidden(Lcom/android/server/content/SyncOperation;)Z
    invoke-static {v0, v1}, Lcom/android/server/content/SyncManager;->access$3900(Lcom/android/server/content/SyncManager;Lcom/android/server/content/SyncOperation;)Z
    ...
    invoke-static {v0, v1}, Lcom/android/server/content/SyncManagerInjector;->isSyncForbidden(Landroid/content/Context;Lcom/android/server/content/SyncOperation;)Z
    ...
    const-string v34, "Sync is forbidden by Injector"
    ...
    invoke-static {}, Lcom/android/server/content/SyncManager;->access$4100()I
    ...
    invoke-static {}, Lcom/android/server/content/SyncManager;->access$4200()I
    ...
    invoke-static {v9}, Lcom/android/server/content/SyncManagerInjector;->isRoomAvailable(Lcom/android/server/content/SyncOperation;)Z
...
.method private runSyncFinishedOrCanceledH(Landroid/content/SyncResult;Lcom/android/server/content/SyncManager$ActiveSyncContext;)V
    ...
    invoke-static {v3, v6}, Lcom/android/server/content/SyncManager;->access$4600(Lcom/android/server/content/SyncManager;Lcom/android/server/content/SyncOperation;)V
    ...
    invoke-static {v3, v6, v4, v5}, Lcom/android/server/content/SyncManager;->access$4700(Lcom/android/server/content/SyncManager;Lcom/android/server/content/SyncOperation;J)V
    ...
    # getter for: Lcom/android/server/content/SyncManager;->mNotificationMgr:Landroid/app/NotificationManager;
    invoke-static {v3}, Lcom/android/server/content/SyncManager;->access$4800(Lcom/android/server/content/SyncManager;)Landroid/app/NotificationManager;
